...
# Parametreler
npz_file = 'tfidf_full_lemma.npz'
vectorizer_file = 'tfidf_vectorizer_lemma.pkl'
book_names_file = 'book_names_lemma.pkl'
sentences_file = 'books_lemmatized.csv'

query_idx = 0  # sorgu satırı

output_dir = 'outputs'
os.makedirs(output_dir, exist_ok=True)
output_csv = os.path.join(output_dir, 'tfidf_top5_lemma_unique_books.csv')
