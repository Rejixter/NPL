...
model_name = f"word2vec_lemma_cbow_w{window}_d{vector_size}.model"
model_path = os.path.join(current_dir, model_name)
model.save(model_path)

vector_out_path = os.path.join(current_dir, f"vectors_lemma_cbow_w{window}_d{vector_size}.csv")
